...
const resources = {
  'en-US': {
    translation: {
      ...
      "room_not_found": "Room not found or game has ended.",
      "invalid_room_code": "Invalid room code format.",
      "room_connection_timeout": "Connection timeout trying to join room. Please check if the server is active.",
      "error": "Error",
      "back": "Back",
      "qr_code": "QR Code",
  ...
  'pt-PT': {
    translation: {
      ...
      "room_not_found": "A sala não foi encontrada ou já terminou.",
      "invalid_room_code": "Formato de código de sala inválido.",
      "room_connection_timeout": "Tempo limite ao tentar entrar na sala. Verifica a tua ligação ou se o servidor está ativo.",
      "error": "Erro",
      "back": "Voltar",
      "qr_code": "Código QR",
  ...
  'es-ES': {
    translation: {
      ...
      "room_not_found": "La sala no fue encontrada o ya ha terminado.",
      "invalid_room_code": "Formato de código de sala no válido.",
      "room_connection_timeout": "Tiempo de espera agotado al entrar a la sala. Comprueba si el servidor está activo.",
      "error": "Error",
      "back": "Volver",
      "qr_code": "Código QR",
  ...
  'fr-FR': {
    translation: {
      ...
      "room_not_found": "La salle est introuvable ou est terminée.",
      "invalid_room_code": "Format de code de salle invalide.",
      "room_connection_timeout": "Délai d'attente dépassé pour rejoindre la salle. Vérifiez si le serveur est actif.",
      "error": "Erreur",
      "back": "Retour",
      "qr_code": "Code QR",
